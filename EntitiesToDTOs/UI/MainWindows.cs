...
using IMM.EntitiesToDTOs.Properties;
...
namespace EntitiesToDTOs.UI
{
    public partial class MainWindows : Form
    {
        ...
        /// <summary>
        /// Referencia Para Visualizar el Progreso en el StatusBar de Visual Studio
        /// </summary>
        private ProgressVisualStudio ProgressVS { set; get; }
        ...
        private EdmxDocument CurrentSourceEdmx
        {
            ...
            {
                // Validate EDMX
                if ((this.rbSourceEdmx.Checked) && this.lstEntitySources.SelectedItem != null)
                {
        ...
        public MainWindows(DTE2 applicationObject)
        {
            InitializeComponent();
            try
            {
                ...
                else
                {
                    ...
                    this.EdmxItems.AddRange(solutionItems
                        .Where(i => i.Name.EndsWith(Resources.EdmlFileExtension))
                        .OrderBy(i => i.Name).ToList());
        ...
        {
            MessageBox.Show("Gracias por Utilizarme");
        }
        ...
        private void Generate()
        {
            try
            {
                ...
                this.ProgressVS = new ProgressVisualStudio();
                this.ProgressVS.Start(generatorParams.DTOsParams.EDMXProjectItem.Name);
