    ...
    internal class ConfigurationHelper
    {
        ...
        public static GeneratorManagerParams Import(string filePath)
        {
            ...
            if (targetNodeDTOs == null)
            {
                ...
                targetNodeDTOs = dtosConfigNode.Descendants(ConfigNodes.TargetAttrProject).First();
            ...
            if (result.GenerateAssemblers)
            {
                ...
                {
                    // Legacy config (v2.* and older)
                    targetNodeAssemblers = assemblersConfigNode.Descendants(ConfigNodes.TargetAttrProject).First();
